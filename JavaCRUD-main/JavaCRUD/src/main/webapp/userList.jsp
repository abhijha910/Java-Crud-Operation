...
<body>
	...
	<table>
		<thead>
			<tr>
				...
				<th style="border-spacing: 5px;">Phone Number</th> <!-- New Column for Phone Number -->
				<th style="border-spacing: 5px;">Email</th>
				<th style="border-spacing: 5px;">Address</th> <!-- New Column for Address -->
	...
	%>
		...
		<tr>
			...
			<td><%=user.getFname() %></td>
			<td><%=user.getLname() %></td>
			<td><%=user.getPhoneNumber() %></td> <!-- Display Phone Number -->
			<td><%=user.getEmail() %></td>
			<td><%=user.getAddress() %></td> <!-- Display Address -->
			<td><%=user.getUname() %></td>
		</tr>
